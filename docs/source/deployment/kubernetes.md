...
Install the pre-built chart **aiq2-web** version **2.2.1** from the NGC Helm repository (`https://helm.ngc.nvidia.com/nvidia/blueprint/charts/`).
...
change the published NGC 2.2.1 instructions above.
